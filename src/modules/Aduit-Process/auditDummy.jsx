...
//     try {
//       await axios.put(`${API_BASE_URL}/audit/ustatus/${id}`);
...
//       fd.append("payment_requested_by", formData.payment_requested_by || "");
//       fd.append(
...
//       await axios.put(`${API_BASE_URL}/audit/update/${editId}`, fd, config);
...
//         national_id: item.national_id ?? "",
//         phone_number: item.phone_number ?? "",
//         visit_date: item.visit_date ? item.visit_date.substring(0, 10) : "",
//         females_below_18: item.females_below_18 ?? "",
//         females_above_18: item.females_above_18 ?? "",
//         males_below_18: item.males_below_18 ?? "",
//         males_above_18: item.males_above_18 ?? "",
...
//         cooking_method_before: item.cooking_method_before ?? "",
//         fuel_used_before: item.fuel_used_before ?? "",
//         other_cooking_device_before: item.other_cooking_device_before ?? "no",
