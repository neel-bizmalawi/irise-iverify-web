...
export class TrainingSiteService {
    ...
    async createTraining(dto: CreateTrainingSiteDto) {
       
        const data = await this.trainingSiteRepo.insertTraining(dto)
    ...
    async getTrainingData(trainingId:number){
        ...
        return {message:"data fetched succesfully"
            ,data}
    }
    ...
    async deleteTraining(trainingId:number){
     ...
     async getDistrict() {
       ...
       return {message:'District fetched',
        data};
    }
      ...
      async getAuthority() {
       ...
       return {message:'Authority fetched',
        data};
    }

    async updateTrain(trainingId:number,dto:UpdateTrainingSiteDto)
    {
        return this.trainingSiteRepo.updateTraining(trainingId,dto);
    }
